         ...
         >
           ...
           <p style={{ color: 'white' }}>
             <label>
               ...
               <textarea name="How would you handle Harrasment" style={{ width: '75%' }} onChange={this.handleChange} />
             </label>
           </p>
           <p style={{ color: 'white' }}>
             <label>
               Do you agree to Sign and be Bound to our NDA (Non-Disclosure Agreement)?:<br />
               <textarea name="Do you agree to Sign a NDA?" style={{ width: '75%' }} onChange={this.handleChange} />
             </label>
           </p>
           <p style={{ color: 'white' }}>
             <label>
               What are you more interested in Approving Bots or just Moderating the Server?:<br />
               <textarea name="Approver or Mod?" style={{ width: '75%' }} onChange={this.handleChange} />
             </label>
           </p>
           <p style={{ color: 'white' }}>
             <label>
